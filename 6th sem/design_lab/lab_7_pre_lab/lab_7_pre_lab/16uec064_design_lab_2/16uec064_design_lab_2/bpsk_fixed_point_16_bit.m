...
h = round(((randn(1,N) + 1i*randn(1,N))*sqrt(1/2))*(2^16));  %h complex random ; ray light faded channel
...
y = round((h.*t + sigma(k).*n)*(2^16));                 % find y = channel*bpsk_signal + sigma*noise
